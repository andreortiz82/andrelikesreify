    ...
    return (
      <div className="skill-meter-component">
        <svg width="100%" height="100%" viewBox="0 0 40 40" className={"donut " + this.props.color}>
          ...
          <circle className="donut-ring" cx="21" cy="21" r="15.91549430918954" strokeWidth={strokeWidth}></circle>
          <circle className="donut-segment" cx="21" cy="21" r="15.91549430918954" strokeWidth={strokeWidth} strokeDasharray={ this.props.amount } strokeDashoffset="25"></circle>
